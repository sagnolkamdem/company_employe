...
<div class="col-sm-offset-4 col-sm-4">
        ...
        <div class="panel panel-primary">   
            <div class="panel-heading">Modification d'un employe</div>
            <div class="panel-body"> 
                <div class="col-sm-12"><!--  -->
                {!! Form::model($employe, ['route' => ['employe.update', $employe->id], 'method' => 'put', 'class' => 'form-horizontal panel', 'files' => true]) !!}
                        {!! csrf_field() !!}   
